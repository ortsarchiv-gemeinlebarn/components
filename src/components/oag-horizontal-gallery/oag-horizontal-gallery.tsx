...
export class OagHorizontalGallery {
    ...
    public current: GalleryItem = {
        src: "https://images.unsplash.com/photo-1560826187-7df41feb4831?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1412&q=80",
        caption: "",
        reference: "",
    };
