...
import { DragPan, MouseWheelZoom, defaults as interactionDefaults } from 'ol/interaction';
...
export class OagMap {
            ...
            interactions: interactionDefaults({ dragPan: false, mouseWheelZoom: false }).extend([
                new DragPan({
                    condition: function (event) {
                        if ((this as DragPan).getPointerCount() === 2 || platformModifierKeyOnly(event)) {
                            return true;
                        }

                        OagMap.displayModifyWithKeyOverlay(event);
                ...
                new MouseWheelZoom({
                    condition: function (event) {
                        if (!event.dragging && event.type == 'wheel' && !platformModifierKeyOnly(event)) {
                            OagMap.displayModifyWithKeyOverlay(event);
                        }
    ...
    private static displayModifyWithKeyOverlay(event: MapBrowserEvent<any>) {
        const overlay = event.map.getTargetElement().parentNode.querySelector("#key-pan-overlay");
    ...
    public render() {
        return (
            <Host>
                <div id="key-pan-overlay">
                    <div class="top">Karte zoomen oder bewegen</div>
                    <div class="bottom">
                        <svg width="100%" height="100%" viewBox="0 0 1224 550" version="1.1" style={{ "fill-rule": "evenodd", "clip-rule": "evenodd", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-miterlimit": "1.5" }}>
                            <g transform="matrix(1,0,0,1,-194.48,-627.265)">
                                <g>
                                    <g transform="matrix(1,0,0,1,61.9847,-131.154)">
                                    ...
                                    <g transform="matrix(1.34631,0,0,1.34631,-369.694,-569.25)">
                                    ...
                                    <g transform="matrix(0.146507,0,0,0.146507,529.969,724.556)">
